...
#!/usr/bin/env python
import sys,os
# sys.path.append("/Users/liushaofan/PycharmProjects/")
...
def main(robot='doggo', task='goal1', algo='hrl', seed=1, exp_name="test", cpu=1):

    # Verify experiment
    robot_list = ['point', 'car', 'doggo']
    task_list = ['goal1', 'goal2', 'button1', 'button2', 'push1', 'push2']
    algo_list = ['ppo', 'ppo_lagrangian', 'trpo', 'trpo_lagrangian', 'cpo', 'hrl']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, default='hrl')
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--exp_name', type=str, default='v0')
